...
export function computeMarketFromNew(msrp, retail, year, opts = {}) {
  // Sanity check : si retail < msrp / 2, le LLM a probablement classé un prix
  // occasion en retail. On l'ignore pour ne pas pourrir le calcul.
  let newPrice;
  if (msrp && retail && retail < msrp / 2) {
    newPrice = msrp;
  } else {
