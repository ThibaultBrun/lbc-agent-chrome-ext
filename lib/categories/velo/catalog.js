...
export const KNOWN_REFURBISHERS = [
  { name: "Upway", domain: "upway.fr" },
  { name: "Buycycle", domain: "buycycle.com" },
  { name: "MyVeloShop", domain: "myveloshop.com" },
  { name: "Rebike", domain: "rebike.com" },
  { name: "MINT-Bikes", domain: "mint-bikes.com" },
  { name: "Tones Of Bikes", domain: "tonesofbikes.com" },
  { name: "Bikeflip", domain: "bikeflip.com" },
];
