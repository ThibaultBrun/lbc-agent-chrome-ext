...
10. must_check : 2-5 bullets ACTIONNABLES pour l'acheteur lors de l'essai. Issus
   de la fiabilite si fournie. Exemples :
   - 'Verifier facture chaine de distribution apres 150k km'
   - 'Demander historique entretien complet'
   - 'Tester boite a froid (passage 1ere/2eme rapide)'
   - 'Controler etat FAP, voyant moteur'
   - 'Verifier date du dernier CT et contre-visite'
